...
3. **링크 블록 관리**
   - 링크 추가/수정/삭제.
   - **연필 아이콘 편집 UI:** 링크 아이템에 연필 아이콘을 표시하고, 클릭 시 제목 및 URL 수정 모드 진입.
...
- **링크 목록 영역:**
  ...
  - 리스트 아이템:
    ...
    - 제목/URL: 텍스트 또는 연필 아이콘 클릭 시 인라인 수정 모드 진입.
    - 연필 아이콘: 링크 제목 및 URL 수정 가능 상태를 표시.
    - 삭제 버튼: 우측/좌측 위치.

### 3.3. 디자인 시스템 (UI/UX)

- **프레임워크:** shadcn/ui.
- **인터랙션:** 빠르고 간편한 수정 경험을 위해 연필 아이콘 기반 인라인 편집 UX 최적화 (엔터 키 저장, 포커스 아웃 저장 등).
